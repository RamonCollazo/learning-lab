...
# Pane 1 - Bottom Left
tmux send-keys -t "$SESSION_NAME":0.1 'echo -e "\033[1m🦅 millennium-falcon\033[0m\n\n"; kubectl exec -ti millennium-falcon -- socat UDP4-RECVFROM:8888,reuseaddr,ip-add-membership=225.0.0.21:0.0.0.0,fork -' C-m
