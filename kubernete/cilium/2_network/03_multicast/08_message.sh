...
sendmsg millennium-falcon 225.0.0.21:8888 "🦅 Yahoo!"
sendmsg millennium-falcon 225.0.0.21:8888 "🦅 You're all clear, kid."
sendmsg millennium-falcon 225.0.0.21:8888 "🦅 Now let's blow this thing and go home!"
...
sendmsg millennium-falcon 225.0.0.21:8888 "🦅 Great shot, kid. That was one in a million."
sendmsg obi-wan 225.0.0.42:7777 "👻 Remember, the Force will be with you... always."

kubectl scale deploy/deathstar --replicas=0

# Observe messages on main terminal window

# On second terminal window, verify that the deathstar pod is terminated
